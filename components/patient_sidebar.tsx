...
export function PatientSidebar({ user }: SidebarProps) {
    ...
    console.log("Current Nav Items:", currentNavItems)
                                        ...
                                        <div className="mb-2">
                                            ...
                                            {!collapsed && (
                                                <ul className="mt-1 pl-10 space-y-1">
                                                    {item.subItems.map((subItem: NavItem) => ( // Explicitly type subItem
                                                        <li key={subItem.name}>
                                                            <Link
                                                                href={subItem.href}
                                                                className={cn(
